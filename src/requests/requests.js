...
export const getIncidentWithTweets = (id) => axios.get(`/incidents/${id}`);

//get to current user
export const getCurrentUser = () => axios.get(`/auth/currentUser`);

//POST REQUESTS

//post to incidents
export const postIncidents = (data) => axios.post(`/incidents`, data);

//post to actions
export const postActions = (data) => axios.post(`/actions`, data);

//post to tweets
export const postTweets = (data) => axios.post(`/tweets`, data);

//post to image upload
export const upload = (data) => axios.post("/incidents/upload", data);
...
export const patchDenyIncident = (data) => axios.patch(`/incidents/deny`, data);
...
export const patchApproveTweet = (data) => axios.patch(`/tweets/approve`, data);

//patch to tweets deny
export const patchDenyTweet = (data) => axios.patch(`/tweets/deny`, data);

//patch to tweets
export const patchTweet = (data, id) => axios.patch(`/tweets/${id}`, data);
...
export const patchDenyAction = (data) => axios.patch(`/actions/deny`, data);

//patch to actions
export const patchAction = (data, id) => axios.patch(`/actions/${id}`, data);
