...
taylor = Incident.create(title: "Breonna Taylor killed in her own home" , description: "Breonna Taylor was fatally shot by Louisville Metro Police Department", date: "3/13/20", image_url: "https://dynaimage.cdn.cnn.com/cnn/c_fill,g_auto,w_1200,h_675,ar_16:9/https%3A%2F%2Fcdn.cnn.com%2Fcnnnext%2Fdam%2Fassets%2F200512170612-01-louisville-emt-police-killed.jpg", lat: "38.2527", lng: "-85.7585")

bird = Incident.create(title: "White woman who called police on black birdwatcher" , description: `Central Park this morning: This woman's dog is tearing through the plantings in the Ramble.
...
buffalo = Incident.create(title: "Buffalo officers push 75-year-old protester" , description: "police officers from the Buffalo Police Department pushed 75-year-old Martin Gugino during a confrontation in Buffalo's Niagara Square, causing him to fall to the ground which left him bleeding from the ear. ", date: "6/5/20", image_url: "https://s.abcnews.com/images/US/200605_abc_social_buffalo1_hpMain_16x9_992.jpg", lat: "42.886910", lng: "-78.878070")

atlanta = Incident.create(title: "Atlanta officers attack college students in car" , description: "The Louisville Metro Police officer who was caught on camera Friday firing pepper balls at a WAVE 3 reporter and photojournalist as they covered the downtown protests over Breonna Taylor's death has been reassigned", date: "6/1/20", image_url: "https://e3.365dm.com/20/06/1600x900/skynews-atlanta-george-floyd_5004585.jpg?20200602184523", lat: "33.748997", lng: "-84.387985")

louisville = Incident.create(title: "Louisville officer fired pepper balls at reporter" , description: "", date: "6/12/20", image_url:"https://s3.amazonaws.com/abn-prod/wp-content/uploads/sites/4/2020/05/wave3-protest.jpg", lat: "38.252666", lng: "-85.758453")

bronx = Incident.create(title: "Teen Allegedly Beaten, Tased by Cops in Bronx" , description: "16-year-old was beaten and Tased by NYPD", date: "6/10/20", image_url: "https://i.dailymail.co.uk/1s/2020/06/11/14/29489522-8410537-image-m-20_1591883114281.jpg", lat: "40.8448", lng: "-73.8648")

meadow = Incident.create(title: "East Meadow, New York. Police arrest a man for protesting. We no longer are free." , description: "Peaceful protest in East Meadow, NY (Long Island): 
...
Tweet.create(url: 'https://twitter.com/RexChapman/status/1271832001364979716', incident_id:meadow.id)
Tweet.create(url: 'https://twitter.com/bbyches/status/1271622738990555136', incident_id:meadow.id)
Tweet.create(url: 'https://twitter.com/JaredSawyerJr/status/1272126918742204420', incident_id:atlanta.id)
Tweet.create(url: 'https://twitter.com/QuickTake/status/1128105106111651840', incident_id: eric.id)
Tweet.create(url: 'https://twitter.com/Reuters/status/1268799719569936384  ', incident_id:buffalo.id)
Tweet.create(url: 'https://twitter.com/eileenstreet/status/1266899001191915520', incident_id:louisville.id)
Tweet.create(url: 'https://twitter.com/JoshuaPotash/status/1271234726465024007', incident_id:taylor.id)
Tweet.create(url: 'https://twitter.com/camilateleSUR/status/1272040100873060352', incident_id:brooks.id)
Tweet.create(url: 'https://twitter.com/_SJPeace_/status/1265076047890001921', incident_id:bird.id)
Tweet.create(url: 'https://twitter.com/mikewhoatv/status/1265258873490944001', incident_id:floyd)
Tweet.create(url: 'https://twitter.com/thepopcornreel/status/1271980346368638976', incident_id:brooks.id)
Tweet.create(url: 'https://twitter.com/GAFollowers/status/1272117864649154560', incident_id:brooks.id)
# Tweet.create(url: '', incident_id:)
# Tweet.create(url: '', incident_id:)
# Tweet.create(url: '', incident_id:)